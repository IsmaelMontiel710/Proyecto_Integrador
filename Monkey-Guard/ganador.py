...
while run:
    ...
    if variables.ingles==True:
        ...
        pantalla.blit(variables.fuente.render(variables.Ingles[11],1,(0,0,0)), (370, 100))
    else:
        pantalla.blit(variables.fuente.render(variables.Español[2],1,(0,0,0)), (370, 445))
        pantalla.blit(variables.fuente.render(variables.Español[11],1,(255,255,255)), (370, 100))
